...
import com.jdruanjian.pk10.model.basicmodel.GetPriceModel;
import com.jdruanjian.pk10.model.basicmodel.OrderPriceModel;
import com.jdruanjian.pk10.model.basicmodel.ReChargeModel;
import com.jdruanjian.pk10.ui.activity.AboutUsActivity;
import com.jdruanjian.pk10.ui.activity.LoginActivity;
import com.jdruanjian.pk10.ui.activity.ModifyPassWordActivity;
import com.jdruanjian.pk10.ui.activity.Result_PK_Activity;
import com.jdruanjian.pk10.utils.DataCleanManager;
...
public class Fragment3 extends BaseFragment {
    ...
    private String ID, Name, Url, endtime;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        System.out.println("-------========" + PrefUtils.getString(getActivity().getApplication(), "endtime", null));
    ...
    @OnClick({R.id.tv_week, R.id.btn_calculate, R.id.tv_month, R.id.tv_halfyear, R.id.tv_yaer, R.id.tv_forever, R.id.btn_ensure_buy, R.id.btn_history, R.id.btn_modifypwd, R.id.btn_satement, R.id.btn_logout})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_modifypwd:
                Intent intentft = new Intent(getActivity(), ModifyPassWordActivity.class);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (orderPriceModel.status.equals("0")) {
                            Name = orderPriceModel.data.url_1;
                        } else {
