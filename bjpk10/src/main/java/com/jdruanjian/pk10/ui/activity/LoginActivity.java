...
import com.jdruanjian.pk10.model.entity.LoginBean;
...
public class LoginActivity extends BaseActivity {
    ...
    private void saveUserMsg() {
        ...
        PrefUtils.putString(getApplication(), "uname",  etUsername.getText().toString());
        PrefUtils.putString(getApplication(), "upwd",  etPassword.getText().toString());
